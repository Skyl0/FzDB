...
/**
 * Test case for class \Y7group\Y7Fahrzeugdatenbank\Domain\Model\Fahrzeug.
 *
...
class FahrzeugTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Y7group\Y7Fahrzeugdatenbank\Domain\Model\Fahrzeug
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Y7group\Y7Fahrzeugdatenbank\Domain\Model\Fahrzeug();
	}
	 ...
	 * @test
	 */
	public function getDatenblattReturnsInitialValueForFileReference() {
		$this->assertEquals(
			NULL,
			$this->subject->getDatenblatt()
		);
	}
	 ...
	 * @test
	 */
	public function setDatenblattForFileReferenceSetsDatenblatt() {
		$fileReferenceFixture = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
		$this->subject->setDatenblatt($fileReferenceFixture);
	 ...
	 * @test
	 */
	public function getKategorieReturnsInitialValueForFzKategorie() {
		$this->assertEquals(
			NULL,
	 ...
	 * @test
	 */
	public function setKategorieForFzKategorieSetsKategorie() {
		$kategorieFixture = new \Y7group\Y7Fahrzeugdatenbank\Domain\Model\FzKategorie();
